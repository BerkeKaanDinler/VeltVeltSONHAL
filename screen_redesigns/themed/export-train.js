...
const htmlPath = path.join(root, "train_themed.html");
...
for (const theme of themes) {
  const out = path.join(outDir, `02-train-${theme}.png`);
...
const board = path.join(outDir, "02-train-all-themes.png");
...
console.log(`Exported themed Train screens to ${outDir}`);
